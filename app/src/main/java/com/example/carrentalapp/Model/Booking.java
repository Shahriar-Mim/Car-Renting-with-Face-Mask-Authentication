...
public class Booking implements Serializable {
    ...
    public Booking(int bookingID, Calendar pickupDate, Calendar returnDate, String bookingStatus, int customerID, int billingID, int vehicleID, String insuranceID) {
